...
const LoaderSteps = () => {
  ...
  return (
    <div className="w-full h-full flex flex-col items-center justify-center bg-gray-950 relative overflow-hidden text-white">
        <div className="absolute inset-0 bg-linear-to-br from-blue-500/10 via-purple-500/10 to-fuchsia-500/10 blue-3xl animate-pulse">
        </div>
        <div className="relative z-10 w-32 h-31 flex items-center justify-center">
        ...
        {/* step label -fade using transition onlu (no visible star) */}
        <p key={current} className="mt-8 duration-700 ease-in-out opacity-100">{steps[current].label}</p>
